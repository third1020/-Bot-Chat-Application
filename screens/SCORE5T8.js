...
export default class SCORE5T8 extends React.Component {
    ...
    render() {
        return (
         <ChatBot
            ...
            {
                id: '1',
                message: 'จากการประเมินเบื้องต้นเราพบว่าคุณมีความเสี่ยงในการทำร้ายตัวเองในระดับรุนแรง และมีความเสี่ยงในการฆ่าตัวตายในระดับน้อย',
                trigger: '2',
              },
              {
                id: '2',
                options: [
                  ...
                  {  label: 'ฉันยังไม่ต้องการความช่วยเหลือ', trigger:'cbt1'},
                ],
              },
              {
                id: '3',
